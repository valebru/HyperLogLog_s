...
function configure(parser)
	...
	parser:option("-t --txrate", "TX_Rate - in MBit/s."):args(1):convert(tonumber):default(0)
...
--      stats.startStatsTask{devices = args.dev}
	...
	args.dev[1]:getTxQueue(0):setRate(txrate)
	args.dev[1]:getTxQueue(1):setRate(txrate)
	args.dev[1]:getTxQueue(2):setRate(txrate)
