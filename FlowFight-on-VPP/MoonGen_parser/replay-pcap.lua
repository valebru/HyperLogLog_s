...
--      stats.startStatsTask{devices = args.dev}
	...
	mg.startTask("replay", args.dev[1]:getTxQueue(1), args.file, args.loop, rateLimiter, args.rateMultiplier)
	mg.startTask("replay", args.dev[1]:getTxQueue(2), args.file, args.loop, rateLimiter, args.rateMultiplier)
	mg.waitForTasks()
end
